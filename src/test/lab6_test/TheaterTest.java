import com.lab6.Theater.SeatIndex;
import com.lab6.Theater.Implementation.UnsafeTheater;
...
class TheaterTest {
    ...
    void BookSeats_InvalidSeats_ShouldThrow() {
        ...
        assertThrows(IndexOutOfBoundsException.class, () -> theater.bookSeats(hallNumber, row, seat));
    }
    ...
    void CheckAvailability_AvailableSeats_ShouldReturnTrue() {
        ...
        assertTrue(theater.checkAvailability(hallNumber, row, numSeats));
    }
    ...
    void CheckAvailability_UnavailableSeats_ShouldReturnFalse() {
        ...
        assertFalse(theater.checkAvailability(hallNumber, row, 10));
    }
    ...
    void PrintSeatingArrangement_ShouldNotThrow() {
        ...
        assertDoesNotThrow(() -> theater.printSeatingArrangement(hallNumber));
    }
